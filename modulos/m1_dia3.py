...
from assets import ELEMENTOS, generar_svg_enlace, generar_svg_tira_afloja
...
def mostrar_dia3():
    ...
    c1, c2 = st.columns(2)
    with c1:
        masa = st.slider("Masa de Soluto (g de NaCl):", min_value=1.0, max_value=100.0, value=5.8)
        volumen = st.slider("Volumen (Litros de H2O):", min_value=0.1, max_value=5.0, value=1.0)
